...
public class Areas extends ActivityBase {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Vector<String> areas = Area.findAreas(this, area,
				extras.getString("prefecture"));
		...
		areas_list.setAdapter(new ArrayAdapter<String>(this,
				android.R.layout.simple_list_item_1, (String[]) areas
						.toArray(new String[areas.size()])));
		areas_list
